package lumi.constellation.layout;
...
import lumi.constellation.utils.internal.ToolbarLayoutUtils;
import lumi.constellation.view.internal.NavigationBadgeIcon;
...
public class ToolbarLayout extends LinearLayout {
    ...
    protected void initLayoutAttrs(@Nullable AttributeSet attrs) {
        ...
        try {
            mLayout = a.getResourceId(R.styleable.ToolbarLayout_android_layout,
                    R.layout.lumi_layout_toolbarlayout_appbar);
    ...
    protected void inflateChildren() {
        if (mLayout != R.layout.lumi_layout_toolbarlayout_appbar) {
        ...
        addView(inflater.inflate(
                R.layout.lumi_layout_toolbarlayout_footer, this, false));
    }
            ...
            if (count != 0) {
                ...
                if (count == N_BADGE) {
                    badgeIcon.setText(mContext.getResources()
                            .getString(R.string.lumi_new_badge_text));
                } else {
    ...
    public void setActionModeCount(int count, int total) {
        String title = count > 0
                ? getResources().getString(R.string.lumi_action_mode_n_selected, count)
                : getResources().getString(R.string.lumi_action_mode_select_items);
