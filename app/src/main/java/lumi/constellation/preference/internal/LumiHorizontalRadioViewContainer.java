package lumi.constellation.preference.internal;
...
public class LumiHorizontalRadioViewContainer extends LinearLayout {
    private boolean mIsDividerEnabled;

    public LumiHorizontalRadioViewContainer(Context context) {
        super(context);
    }

    public LumiHorizontalRadioViewContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LumiHorizontalRadioViewContainer(Context context, AttributeSet attrs, int defStyleAttr) {
