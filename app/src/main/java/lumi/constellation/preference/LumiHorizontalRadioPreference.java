...
import lumi.constellation.preference.internal.LumiHorizontalRadioViewContainer;

public class LumiHorizontalRadioPreference extends Preference {
    private static final String TAG = "LumiHorizontalRadioPreference";
    ...
    private LumiHorizontalRadioViewContainer mContainerLayout;
    private int mSelectedColor;
    private int mUnselectedColor;


    @SuppressLint({"RestrictedApi", "LongLogTag"})
    public LumiHorizontalRadioPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setLayoutResource(R.layout.lumi_horizontal_radio_preference_layout);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        for (CharSequence str : mEntryValues) {
            ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.lumi_horizontal_radio_preference_item, mContainerLayout);
