...
public class LumiDetailedColorPickerPreference extends Preference implements Preference.OnPreferenceClickListener,
    ...
    public LumiDetailedColorPickerPreference(Context context) {
        this(context, null);
    }

    public LumiDetailedColorPickerPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LumiDetailedColorPickerPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void showDialog(Bundle state) {
        SeslColorPickerDialog dialog = new SeslColorPickerDialog(getContext(), this, mValue, getRecentColors(), mAlphaSliderEnabled);
